        ...
        <table className="w-full border-collapse bg-white dark:bg-slate-800">
          <thead>
            <tr className="bg-slate-100 dark:bg-slate-700">
              ...
              <th className="p-4 text-center font-semibold bg-amber-100 dark:bg-amber-900/50 text-amber-900 dark:text-amber-100">
                Essentiel ⭐
              </th>
              <th className="p-4 text-center font-semibold text-slate-900 dark:text-white">
                Premium
          ...
          <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
              ...
              <td className="p-4 text-center font-medium bg-amber-50 dark:bg-amber-900/20">10</td>
            ...
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
              ...
              <td className="p-4 text-center bg-amber-50 dark:bg-amber-900/20">Avancés</td>
              <td className="p-4 text-center text-purple-600 dark:text-purple-400">Avancés</td>
            </tr>
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
            ...
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
              <td className="p-4 text-slate-700 dark:text-slate-300">Rapport annuel PDF</td>
              <td className="p-4 text-center">
                <X className="h-5 w-5 text-red-400 mx-auto" />
              </td>
              <td className="p-4 text-center bg-amber-50 dark:bg-amber-900/20">
            ...
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
              ...
              <td className="p-4 text-center">Complet</td>
              <td className="p-4 text-center bg-amber-50 dark:bg-amber-900/20">Complet</td>
              <td className="p-4 text-center text-purple-600 dark:text-purple-400">Complet</td>
            </tr>
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
              <td className="p-4 text-slate-700 dark:text-slate-300">Rapports personnalisés</td>
              <td className="p-4 text-center">
                <X className="h-5 w-5 text-red-400 mx-auto" />
              </td>
              <td className="p-4 text-center bg-amber-50 dark:bg-amber-900/20">
            ...
            <tr className="hover:bg-slate-50 dark:hover:bg-slate-750">
              ...
              <td className="p-4 text-center bg-amber-50 dark:bg-amber-900/20">Email</td>
              <td className="p-4 text-center text-purple-600 dark:text-purple-400">Prioritaire</td>
            </tr>
          </tbody>
        </table>
      </div>
