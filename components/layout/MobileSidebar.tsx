  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 bg-slate-900/90 backdrop-blur-sm border border-slate-800 rounded-lg text-[var(--color-brand-secondary)] hover:bg-slate-800 transition-colors focus-ring-inset"
      ...
      >
        ...
        <button
          onClick={() => setDrawerOpen(false)}
          className="absolute top-4 right-4 z-10 p-2 bg-slate-800/90 backdrop-blur-sm border border-slate-700 rounded-lg text-[var(--color-text-secondary)] hover:text-[var(--color-brand-secondary)] transition-colors focus-ring-inset"
