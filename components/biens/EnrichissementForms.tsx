          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="flex h-10 w-full rounded-md border border-slate-600 bg-slate-700 text-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 hover:bg-slate-600"
              >
                <option value="virement" className="bg-slate-800 text-white">Virement bancaire</option>
                <option value="prelevement" className="bg-slate-800 text-white">Prélèvement automatique</option>
                <option value="cheque" className="bg-slate-800 text-white">Chèque</option>
                <option value="especes" className="bg-slate-800 text-white">Espèces</option>
              </select>
            </div>
          </div>
